      ...
      <?php include_once("./template/header.php");?>
        ...
        <div class="container">
          <div class="card-header"style="background-color: #b3b3cc">
                  ...
                  <div class="form-group col-sm-4">
                    <label>TO</label>
                    <input type="date" class="form-control" name="etd"id="etd"placeholder="" required>
                  </div>

                  <div class="form-group col-sm-4">
                    </br>
                    <button id="searchbt" name="searchbt" style="width:150px;" class="btn btn-info">Search</button>
                    <!--<input type="date" class="form-control" name="std"id="std"placeholder="" required> -->
                  </div>
                </div>
            </div>
