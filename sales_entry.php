...
<head>
    ...
    <script type="text/javascript" src="js/sales_entry.js"></script>
            ...
            <div class="col-md-12 mx-auto">
              <div class="card" style="box-shadow: 0 0 15px 0 lightgray;">
                <div class="card-header">
                  ...
                  <div class="card-body">
                    <form id="sales_entry_form" onsubmit="return false">
                      ...
                      <!--     <div class="form-group col-sm-">
                          ...
                          <div class="form-group col-sm-">
                            <input type="text" class="form-control" id="invoice_no" name="invoice_no" placeholder="Sales Invoice No" required>
                          </div> -->
                          ...
                          <div class="form-group col-sm">
                            <select id="customer" name="customer" class="form-control">
                              <option value='0'>Supplier / Buyer Name</option>
                           </select>
                          </div>
                         </div>
                   ...
                   <center>
                     <input type="submit" id="sales_entry"name="submit" style="width:200px;" class="btn btn-info" value="Entry Sales">
