         ...
         <br/>
          ...
          <div class="container ">
            <div class="card mx-auto" style="width: 20rem;">
                <h4 class="card-title mx-auto"> Login</h4>
            <img class="card-img-top mx-auto" style=width=60% src="./images/loginpannel.png" alt="image icon">
              <div class="card-body">
                <form>
              <div class="form-group">
               <!-- <label for="exampleInputEmail1">Email address</label> -->
               <label>Username</label>
                <input type="email" class="form-control" id="exampleInputEmail1" placeholder="Username"><!-- aria-describedby="emailHelp" placeholder="Enter email">-->
              ...
              <button type="submit" class="btn btn-primary mx-auto" id="submit"><i class="fa fa-lock"></i>&nbsp; Submit </button>
